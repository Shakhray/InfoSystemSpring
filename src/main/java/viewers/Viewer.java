...
public class Viewer {
    ...
    public void changeGroup(int i) {
        switch (i) {
            ...
            case 1: {
                System.out.print("groups number: ");
                break;
            }
            case 2: {
    ...
    public void xmlOrSerial() {
        System.out.println("Enter 'xml' that work with xml database or 'serial' that work with serealizations dayabase.");
        System.out.println("Registr of commands does not matter.");
    }

    public void xmlOrSerialErrorCommand() {
    ...
    public void help() {
        System.out.println("STUDENTS - print list of all students.");
        System.out.println("ADD - add new students to database. Enter ADD and enter information about new student.");
        System.out.println("UPDATE - update fields of student in database. Enter UPDATE, enter number of student in database, then enter fields of student. If entering field is empty, field has no change.");
        System.out.println("DELETE - delete student of database. Enter DELETE and enter number of student in database.");
        System.out.println("EXIT - exit from program.");
        System.out.println("FIND - find students and groups. Enter FIND and string for searching.");
        System.out.println("UNDO - undo of operation.");
        System.out.println("GROUPS - print list of groups.");
        System.out.println("RENAMEGROUP - rename group. Enter RENAMEGROUP, faculty, group number and new group number.");
        System.out.println("COPY - copy from \"students.xml\" to \"students2.xml\".");
